...
class Amazon_AdsStartDateTest(StartDateTest, Amazon_AdsBaseTest):
    ...
    def streams_to_test(self):
        streams_to_exclude = {
            ...
            'sponsored_products_ads', 'invoices', 'sponsored_brands_budget_rules', 'sponsored_products_budget_rules',
            'sponsored_display_campaigns', 'sponsored_display_product_ads', 'sponsored_display_ad_groups',
            'sponsored_display_targetings', 'sponsored_display_campaigns_budget_rules', 'sponsored_display_creatives', 'profiles', 'portfolios', 'sponsored_display_budget_rules_campaigns', 'sponsored_display_budget_rules_campaigns'}
